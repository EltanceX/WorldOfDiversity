...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i1 false, ; bool have_runtime_config_blob
	...
	i32 195, ; uint32_t number_of_assemblies_in_apk
...
@dso_cache = dso_local local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x11af8387968e84ce, ; from name: SDL2
		i64 u0xafcd083c32e1583d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.2_name, ; name: libSDL2.so
		ptr null; void* handle
	}, ; 4
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x24aa335ace2887fd, ; from name: libSDL2-2.0
		i64 u0xb7349f690e9ad904, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libSDL2-2.0.so
		ptr null; void* handle
	}, ; 6
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x37e85816e4a7e624, ; from name: libSDL2
		i64 u0xafcd083c32e1583d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.2_name, ; name: libSDL2.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x49de89cb7af55ee5, ; from name: main
		i64 u0x5e683b9834ef9766, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.1_name, ; name: libmain.so
		ptr null; void* handle
	}, ; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libopenal.so
		ptr null; void* handle
	}, ; 16
	%struct.DSOCacheEntry {
		i64 u0x5e683b9834ef9766, ; from name: libmain.so
		i64 u0x5e683b9834ef9766, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.1_name, ; name: libmain.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9b1e1ffbefc452c9, ; from name: libmain
		i64 u0x5e683b9834ef9766, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.1_name, ; name: libmain.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9d78b40ebd664b71, ; from name: SDL2-2.0.so
		i64 u0xb7349f690e9ad904, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libSDL2-2.0.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa120d6f0b7be6fc6, ; from name: SDL2-2.0
		i64 u0xb7349f690e9ad904, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libSDL2-2.0.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xafcd083c32e1583d, ; from name: libSDL2.so
		i64 u0xafcd083c32e1583d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.2_name, ; name: libSDL2.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb7349f690e9ad904, ; from name: libSDL2-2.0.so
		i64 u0xb7349f690e9ad904, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libSDL2-2.0.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc6552449feb82679, ; from name: SDL2.so
		i64 u0xafcd083c32e1583d, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.2_name, ; name: libSDL2.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe03eb997d16a0514, ; from name: main.so
		i64 u0x5e683b9834ef9766, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.1_name, ; name: libmain.so
		ptr null; void* handle
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [195 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
@.env.1 = private unnamed_addr constant [16 x i8] c"major=marksweep\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.candy.survivalcraft_glass\00", align 1

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [13 x i8] c"libopenal.so\00", align 1
@.DSOCacheEntry.1_name = private unnamed_addr constant [11 x i8] c"libmain.so\00", align 1
@.DSOCacheEntry.2_name = private unnamed_addr constant [11 x i8] c"libSDL2.so\00", align 1
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [15 x i8] c"libSDL2-2.0.so\00", align 1
