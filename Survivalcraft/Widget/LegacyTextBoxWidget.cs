...
namespace Game
{
	...
	public class LegacyTextBoxWidget : Widget
	{
		...
		public override void Draw(DrawContext dc)
		{
			...
			flatBatch2D.QueueQuad(caretCenter - new Vector2(0f, Font.GlyphHeight / 2f * FontScale * Font.Scale), caretCenter + new Vector2(1f, Font.GlyphHeight / 2f * FontScale * Font.Scale), 0f, color);
