...
{
    public class BitmapFont2 : IDisposable
    {
        ...
        public BitmapFont.Glyph[] m_glyphsByCode;
        ...
        public BitmapFont.Glyph FallbackGlyph
        {
            get;
            set;
        }
        ...
        public static BitmapFont Initialize(Stream TextureStream, Stream GlyphsStream, Vector2? customGlyphOffset = null)
        {
            try
            {
                ...
                BitmapFont2 bitmapFont = new();
                StreamReader streamReader = new(GlyphsStream);
                var tmp2 = streamReader.ReadLine();
                ...
                //return bitmapFont;
                var conss = typeof(BitmapFont).GetConstructor(BindingFlags.Instance | BindingFlags.NonPublic,Type.EmptyTypes);
                BitmapFont BmpFontIns = (BitmapFont)RuntimeHelpers.GetUninitializedObject(typeof(BitmapFont));
                BmpFontIns.m_glyphsByCode = bitmapFont.m_glyphsByCode;
                BmpFontIns.m_kerningPairs = bitmapFont.m_kerningPairs;
                BmpFontIns.m_image = bitmapFont.m_image;
                BmpFontIns.Texture = bitmapFont.Texture;
                BmpFontIns.GlyphHeight = bitmapFont.GlyphHeight;
                BmpFontIns.LineHeight = bitmapFont.LineHeight;
                BmpFontIns.Spacing = bitmapFont.Spacing;
                BmpFontIns.Scale = bitmapFont.Scale;
                BmpFontIns.FallbackGlyph = bitmapFont.FallbackGlyph;
                BmpFontIns.MaxGlyphCode = bitmapFont.MaxGlyphCode;
                return BmpFontIns;
        ...
        public BitmapFont2(Texture2D texture, IEnumerable<BitmapFont.Glyph> glyphs, char fallbackCode, float glyphHeight, Vector2 spacing, float scale)
        {
        ...
        public BitmapFont.Glyph GetGlyph(char code)
        {
        ...
        public static BitmapFont2 Load(Image image, char firstCode, char fallbackCode, Vector2 spacing, float scale, Vector2 offset, KerningSettings kerningSettings = null, int mipLevelsCount = 1, bool premultiplyAlpha = true)
        {
        ...
        public static BitmapFont2 Load(Stream stream, char firstCode, char fallbackCode, Vector2 spacing, float scale, Vector2 offset, KerningSettings kerningSettings = null, int mipLevelsCount = 1, bool premultiplyAlpha = true)
        {
        ...
        public static BitmapFont2 Load(string fileName, char firstCode, char fallbackCode, Vector2 spacing, float scale, Vector2 offset, KerningSettings kerningSettings = null, int mipLevelsCount = 1, bool premultiplyAlpha = true)
        {
        ...
        internal BitmapFont2()
        {
        }

        internal static BitmapFont2 InternalLoad(Image image, char firstCode, char fallbackCode, Vector2 spacing, float scale, Vector2 offset, KerningSettings kerningSettings, int mipLevelsCount, bool premultiplyAlpha, bool createTexture)
        {
            ...
            for (int j = 0; j < list2.Count; j++)
            {
                ...
                list3.Add(new BitmapFont.Glyph((char)num5, texCoord, texCoord2, offset2, width));
                num5++;
            }
        ...
        internal void Initialize(Texture2D texture, Image image, IEnumerable<BitmapFont.Glyph> glyphs, char fallbackCode, float glyphHeight, Vector2 spacing, float scale)
        {
            Dispose();
            Texture = texture;
            m_image = image;
            ...
            Spacing = spacing;
            Scale = scale;
            FallbackGlyph = glyphs.First((BitmapFont.Glyph g) => g.Code == fallbackCode);
            MaxGlyphCode = glyphs.Max((BitmapFont.Glyph g) => g.Code);
            m_glyphsByCode = new BitmapFont.Glyph[MaxGlyphCode + 1];
            for (int i = 0; i < m_glyphsByCode.Length; i++)
            {
                m_glyphsByCode[i] = FallbackGlyph;
            }
            foreach (BitmapFont.Glyph glyph in glyphs)
            {
        ...
        public BitmapFont2 Clone(float scale, Vector2 spacing)
        {
            return new BitmapFont2
            {
                m_glyphsByCode = m_glyphsByCode,
                m_kerningPairs = m_kerningPairs,
                m_image = m_image,
